...
public class MyClassLoader extends DexClassLoader {
    ...
    MyClassLoader(FileSpec file, String dexPath, String optimizedDirectory, String libraryPath, ClassLoader parent,
                  MyClassLoader[] deps){
    ...
    public static MyClassLoader getClassLoader(SiteSpec site, FileSpec file) {
        ...
        outdir.mkdir();
        cl = new MyClassLoader(file, path.getAbsolutePath(), outdir.getAbsolutePath(), null,
                               MyApplication.instance().getClassLoader(), ps);
